...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mSHAKIB')
...
while attemps < 12345677901:
    ...
    if username == 'user' and password == 'SHAKIB12':
...
os.system('espeak -a 300 " Welcome,   to,  my,  Tools,  I, am, SHAKIB"')
...
\33[1;96m╔═════════════════════════════════════════╗
\033[93m ║ AUTHOR > \x1b[1;91mMD SHAKIB
\033[32m ║ FB > \x1b[1;97mSHAKIB
\033[95m ║ GITHUB > \x1b[0;34mSHAKIB-12
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[SHAKIB-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
